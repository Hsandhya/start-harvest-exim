    ...
    <footer>
        <div className='f-wrapper'>
            ...
            <div className="sec aboutus">
                <h2>About Us</h2>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Suscipit quae, quisquam et ducimus nostrum eos, voluptas iste neque harum modi nobis sequi excepturi quo id voluptates tenetur inventore libero perspiciatis.</p>
            </div>
